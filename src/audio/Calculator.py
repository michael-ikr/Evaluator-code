...
class Calculator:
    ...
    '''
    Takes in a audio buffer and periodically calls the calculate() in AudioAnalysis class
    Meant to do comparisons in real time. Will use start times to compare and not onsets.
    ...
    '''
    def calculate_and_compare(self, buffer, create_file=False, out_file="", verbose=True, rms_graph=False, from_file = ""):
        start = time.time()
        #Librosa calculations
        sr = 44100
        if from_file != "":
